...
import { GetCarsAsync_carsAsync } from "../../services/carService/__generated__/GEtCarsAsync";
...
const actionDispatch = (dispatch: Dispatch) => ({
  setTopCars: (cars: GetCarsAsync_carsAsync[]) => dispatch(setTopCars(cars)),
});
...
export function TopCars() {
  ...
  const fetchTopCars = async () => {
    setLoading(true);
    const cars = await carService.getCarsAsync().catch((err) => {
